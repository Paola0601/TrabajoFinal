document.addEventListener('DOMContentLoaded', () => {
    ...
    (() => {
        const urlParams = new URLSearchParams(window.location.search); // Commit: Analizar los parámetros de la URL con URLSearchParams
        if (urlParams.get('error') === '1') { // Commit: Verificar si el parámetro "error" está presente y es igual a "1"
            mostrarError(mensajesDeError.credencialesIncorrectas); // Commit: Mostrar mensaje de error para credenciales incorrectas
        }
    })();
